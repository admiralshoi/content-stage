...
<div class="main-wrapper">
    <div class="row mt-5 mb-5 pt-2 flex-row-around">
        <div class="col-sm-12 col-lg-8 col-xl-6">
            <div class="card border-radius-15px">
                <div class="card-body">
                    <p class="flex-row-around font-25">PRIVACY POLICY</p>
                    <div class="font-14 mt-2">
                        ...
                        <div class="mt-3">
                            <p>
                                ...
                                purchase from MYPAGE.com (the “Site”).
                            </p>
                        </div>

                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">PERSONAL INFORMATION WE COLLECT</p>
                            <p>
                        ...
                        <div class="mt-4">
                            <p>
                                ...
                                including your name, billing address, shipping address, payment information (including credit card numbers) VISA, MASTERCARD, PAYPAL,
                        ...
                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">HOW DO WE USE YOUR PERSONAL INFORMATION?</p>
                            <p>
                        ...
                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">SHARING YOUR PERSONAL INFORMATION</p>
                            <p>
                        ...
                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">YOUR RIGHTS</p>
                            <p>
                                If you are a European resident, you have the right to access personal information we hold about you and to ask that
                                your personal information be corrected, updated, or deleted. If you would like to exercise this right,
                        ...
                        <div class="mt-4">
                            <p>
                                ...
                                we might have with you (for example if you make an order through the Site), or otherwise to pursue our
                        ...
                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">DATA RETENTION</p>
                            <p>
                        ...
                        <div class="mt-4">
                            <p class="font-weight-bold text-uppercase">CHANGES</p>
                            <p>
                        ...
                        <div class="mt-4">
                            ...
                            <p>
                                ...
                                please contact us by e‑mail at support@balanziapp.com
                            </p>
                        </div>
