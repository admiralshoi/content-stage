$(function() {
  ...
  showSwal = function(type,page,values) {
  'use strict';
    if (type === 'basic') {
      swal.fire({
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
          if(page == "tgroups"){
            let result = AJAX("delete",page,values);
            let message_body,message_header,message_icon;
            if(result != ""){
              message_header = "ERROR";
              message_body = result;
              message_icon = "error";
            } else  {
              message_header = "Deleted!";
              message_body = "Your item(s) has been deleted";
            ...
            REFRESH("https://apps.zeedia.com/tgroups.php",2500);
          } else {
            swalWithBootstrapButtons.fire(
                'Deleted!',
